...
public class VelocityEstimator : MonoBehaviour
{
	...
	//------------------------------------------------- 
	// starts coroutine to estimate velocity and angular velocity 
	...
	//-------------------------------------------------
	// stops running coroutine if exists
	...
	//-------------------------------------------------
	// calculates the avg velocity from recorded samples
	...
	//------------------------------------------------
	// calculates avg angular velocity from samples
	...
	//-------------------------------------------------
	// calculates avg acceleration based on changes in velocity samples
	...
	//-------------------------------------------------
	// coroutine runs every frame and estimates the linear and angular velocities, updates sample arrays and maintains prev position for next frame calculation
